...
{
	WebDriver driver;
	OrangeHRM_Login_pages login = new OrangeHRM_Login_pages(driver);  //importing the login_page and creating an instance
	@Given("^user launch the chrome browser$")
	public void user_launch_the_chrome_browser() throws Throwable {
	   login.ChromeLaunch();  // calling the url method
	}
	@When("^user open the orange hrm login page$")
	public void user_open_the_orange_hrm_login_page() throws Throwable 
	{
	  login.OrangeHRM_Homepage(); // calling the login page method
	}
	...
	{
	   login.LoginDetails(1); // calling the login details method
	}

	@Then("^user submit the details$")
	public void user_submit_the_details() throws Throwable 
	{
	 login.submit();  // calling the submit method
	}
