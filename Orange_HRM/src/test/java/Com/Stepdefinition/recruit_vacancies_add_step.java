...
{
	recruit_vacancies_add_pages c = new recruit_vacancies_add_pages();  //importing the add_recruitment_vacancies_page and creating an instance
	@Given("^User Launch the Chrome browser$")
	public void user_Launch_the_Chrome_browser() throws Throwable 
	{
	    c.ChromeLaunch();  // calling the url method
	}

	@When("^User Open the Orange hrm login page$")
	public void user_Open_the_Orange_hrm_login_page() throws Throwable 
	{
	   c.OrangeHRM_Homepage();  // calling the login page method
	}
