...
public class OrangeHRM_Recruitment_Pages {  //To click on the recruitment page
	...
	public void Search_item() throws InterruptedException   //To Search the items in the recruitment page
	{
		...
		//To take the Screenshot
				...
				screenshot.renameTo(new File("src/test/resources/Screenshots/image_recruitment_page.png"));
